  ...
  return (
    <nav className="sticky top-0 w-full bg-white shadow-md z-10">
      <div className="max-w-7xl mx-auto flex justify-between items-center px-4 py-3 md:py-4">
        {/* Logo */}
        <Link to="/">
          <img src={logo} alt="Bristol West Logo" className="h-10 md:h-14" />
        </Link>

        {/* Desktop Menu */}
        <ul className="hidden md:flex space-x-6 font-medium text-[#00a98f] items-center">
          <li><Link to="/" className="hover:text-[#ff5100] transition">Home</Link></li>
          <li><Link to="/why-us" className="hover:text-[#ff5100] transition">Why Bristol West</Link></li>
          <li><Link to="/insurance-101" className="hover:text-[#ff5100] transition">Auto Insurance 101</Link></li>
          <li><Link to="/claims" className="hover:text-[#008571] transition">Claims</Link></li>
          <li>
            <Link to="/" className="text-[#ff5100] font-semibold hover:text-[#008571] transition">
              Start Quote
            </Link>
          </li>
          <li>
          ...
          <li className="relative">
            <button
              ...
              className="flex items-center space-x-1 hover:text-[#ff5100] transition focus:outline-none"
            >
      ...
      >
        <ul className="flex flex-col space-y-2 font-medium text-[#00a98f] px-4">
          <li><Link to="/" className="block py-2 hover:text-[#ff5100]">Home</Link></li>
          <li><Link to="/why-us" className="block py-2 hover:text-[#ff5100]">Why Bristol West</Link></li>
          <li><Link to="/insurance-101" className="block py-2 hover:text-[#ff5100]">Auto Insurance 101</Link></li>
          <li><Link to="/claims" className="block py-2 hover:text-[#008571]">Claims</Link></li>
          <li><Link to="/" className="block py-2 text-[#ff5100] font-semibold hover:text-[#008571]">Start Quote</Link></li>
          <li><Link to="/login" className="block py-2 hover:text-[#ff5100]">Login</Link></li>
          <li className="relative">
            <button
              onClick={toggleLangDropdown}
              className="flex justify-between w-full py-2 hover:text-[#ff5100] items-center"
            >
              <span>Español</span>
